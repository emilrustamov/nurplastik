...
<body>
  ...
  <div>
      ...
      <section class="container vertical-line">
        <div class="row">
          <div class="col-xl-6 py-4 px-4 brd-right">
            ...
            <p class="mb-4">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Architecto laudantium magnam
              ratione. Nostrum
              voluptatibus est ab dolorum, temporibus possimus cupiditate eligendi omnis totam illo placeat? Nam est in
              sint corrupti.</p>
    ...
    <section class="container vertical-line px-0" id="products">
      ...
      <h2 class="text-uppercase text-center m-0 py-4 px-4">Полипропиленовые решения, которым доверяют по всему миру</h2>
      <div class="products slider px-0">
        <div>
          ...
          <div class="justify-content-between d-flex align-items-center py-2">
            ...
            <button class="product-btn custom-btn d-flex" data-bs-toggle="modal" data-bs-target="#exampleModal"> {{
          ...
          <div class="modal-body">
            <div class="row">
              ...
              <div class="col-xl-6">
                ...
                <p>
                  Количество и тип строп: Наша компания является ведущим производителем полипропиленовой ткани и мешков
                  для пищевой промышленности.
                  Размеры дна: Наша компания является ведущим производителем полипропиленовой ткани и мешков для пищевой
                  промышленности.
                  Высота загрузки: Наша компания является ведущим производителем полипропиленовой ткани и мешков для
                  пищевой промышленности.
                </p>
                <div class="d-flex">
                  <button class="contact-btn me-4">Позвонить<i class="fas fa-phone"></i></button>
                  <button class="contact-btn">Написать<i class="fas fa-envelope"></i></button>
                </div>
              </div>
            </div>
          </div>
      ...
      <section class="container vertical-line px-4">
        <div class="row align-items-center py-4">
          <div class="col-xl-8 col-md-7">
            <p class="py-4 m-0">Sed ipsum ut nisi vitae. Elit euismod aliquet pulvinar consequat vulputate at. Lorem
              eros
              mattis quisque mollis ut odio a. Velit facilisi hac vitae nisi purus.</p>
          </div>
          <div class="col-xl-4 col-md-5">
            <div class="d-flex justify-content-md-end justify-content-start">
              <button class="catalog-btn">{{__('translation.catalog')}}<i class="fas fa-file-download"></i></button>
            </div>
          </div>
      </section>
    </section>
      ...
      <form method="POST">
        ...
        <div class="row">
          <div class="form-group col-xl-6 col-12 mb-4">
            ...
            <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" id="form-name"
              aria-describedby="name" placeholder="Рустам">
            @error('name')
          ...
          <div class="form-group col-xl-6 col-12 mb-4">
            ...
            <input type="phone" name="phone" class="form-control @error('phone') is-invalid @enderror" id="form-phone"
          ...
          <div class="form-group col-xl-6 col-12 mb-4">
            ...
            <input type="email" name="email" class="form-control @error('email') is-invalid @enderror" id="form-email"
