...
<head>
    ...
    <meta name="description"
        content="Nur Plastik - ведущий производитель пластиковых изделий в Туркменистане. Мы предлагаем качественные и надежные продукты.">
    ...
    <div>
        ...
        <main data-bs-spy="scroll" data-bs-target="#navbar-example2" data-bs-offset="0" class="scrollspy-example">
            <section class="container vertical-line">
                <div class="row">
                    <div class="col-lg-7 col-xl-6 py-4 px-4 brd-right d-flex align-items-start justify-content-center"
                        style="flex-direction: column;">
                        <h1 class="mb-4">
                            {{ __('translation.h1') }}
                        </h1>
                        <p class="mb-4"> {{ __('translation.h1_d') }}</p>
                        <a href="#contacts" style="text-decoration: none;"> <button class="contact-btn">
                                <span>{{ __('translation.contact') }}</span><i class="far fa-arrow-alt-circle-right"
                ...
                <div class="row align-items-center py-4">
                    ...
                    <div class="col-xl-4 col-md-5">
                        <div class="d-flex justify-content-md-end justify-content-start">
                            <a href="catalog.pdf" style="text-decoration: none;"><button
                                    class="catalog-btn">{{ __('translation.catalog') }}<i
