        ...
        <div class="tab-content mt-3" id="languageTabsContent">
            <div class="tab-pane fade show active" id="ru" role="tabpanel" aria-labelledby="ru-tab">
                ...
                <div class="mb-3">
                    ...
                    <textarea name="description_ru" class="form-control tinymce-editor @error('description_ru') is-invalid @enderror">{{ old('description_ru') }}</textarea>
            ...
            <div class="tab-pane fade" id="en" role="tabpanel" aria-labelledby="en-tab">
                ...
                <div class="mb-3">
                    ...
                    <textarea name="description_en" class="form-control tinymce-editor @error('description_en') is-invalid @enderror">{{ old('description_en') }}</textarea>
            ...
            <div class="tab-pane fade" id="tm" role="tabpanel" aria-labelledby="tm-tab">
                ...
                <div class="mb-3">
                    ...
                    <textarea name="description_tm" class="form-control tinymce-editor @error('description_tm') is-invalid @enderror">{{ old('description_tm') }}</textarea>
